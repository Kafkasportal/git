/**
 * Appwrite Authentication Test Script (with inline config)
...
async function testAuth() {
  ...
  console.log(`Project Name: kafkasportal`);
  console.log(`Database ID: kafkasder_db`);
  ...
  try {
    ...
    if (error.code === 401) {
      ...
      console.error('   - Make sure "localhost" is added as a platform hostname');
    }
