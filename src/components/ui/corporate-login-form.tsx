  ...
  return (
    <div className={cn(
      ...
      <div className="absolute inset-0 z-0">
        {/* Gradient Orbs */}
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-teal-500/20 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-teal-600/15 rounded-full blur-[100px] translate-x-1/3 translate-y-1/3" />
        <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] bg-teal-400/10 rounded-full blur-[80px] -translate-x-1/2 -translate-y-1/2" />
      ...
      >
        <div className="relative">
          {/* Card Glow */}
          <div className="absolute -inset-1 bg-gradient-to-r from-teal-500 via-teal-400 to-teal-500 rounded-2xl blur-lg opacity-20" />
          ...
          <div className="relative bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              <motion.div
                ...
                className="w-16 h-16 mx-auto mb-5 rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center shadow-lg shadow-teal-500/25"
              >
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <p className="text-xs text-slate-500">
                © {new Date().getFullYear()} KAFKASDER - Çeçen Kafkas Muhacirleri Yardımlaşma ve Dayanışma Derneği
              </p>
