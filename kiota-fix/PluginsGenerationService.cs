...
public partial class PluginsGenerationService
{
    ...
    /// <summary>
    /// Timeout for regular expression operations to prevent ReDoS (Regular Expression Denial of Service) attacks.
    /// </summary>
    ...
    internal bool TryMatchMultipleFilesRequest(string originalFilePath, out uint fileNumber, out uint filesCount)
    {
        ...
        // Check if the file path matches the pattern for multiple OpenAPI files
        var multipleFilesRequestMatch = Regex.Match(originalFilePath, MultipleFilesPattern, RegexOptions.IgnoreCase, RegexTimeout);
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    internal string GetNextFilePath(string originalFilePath, uint fileNumber)
    {
        ...
        var updatedOpenAPIFilePath = Regex.Replace(originalFilePath, $"{MultipleFilesPrefix}1-", $"{MultipleFilesPrefix}{fileNumber}-", RegexOptions.IgnoreCase, RegexTimeout);
